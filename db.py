...
client = MongoClient("mongodb+srv://rithin:welcome123@cluster0-crfgs.mongodb.net/<dbname>?retryWrites=true&w=majority")

chat_db = client.get_database("FlaskChatApp")
